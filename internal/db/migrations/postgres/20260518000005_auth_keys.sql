...
CREATE TABLE IF NOT EXISTS "auth_virtual_keys" (
  ...
  "rate_limit_rps" numeric NOT NULL DEFAULT 0,
...
CREATE UNIQUE INDEX IF NOT EXISTS "idx_auth_virtual_keys_key_hash" ON "auth_virtual_keys" ("key_hash");
...
CREATE UNIQUE INDEX IF NOT EXISTS "idx_auth_api_keys_key_hash"  ON "auth_api_keys" ("key_hash");
CREATE INDEX        IF NOT EXISTS "idx_auth_api_keys_expires_at" ON "auth_api_keys" ("expires_at");
